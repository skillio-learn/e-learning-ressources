...
import { LessonForm } from "@/components/trainer/LessonForm";
    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_300px]">
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <Link href={`/trainer/courses/${id}`} className="text-sm text-slate-500 hover:text-brand-600">← Parcours</Link>
        ...
        <LessonForm
          ...
          newRubricHref={`/trainer/rubrics/new?courseId=${id}&lessonId=${lesson.id}`}
          lesson={{
            title: lesson.title,
