...
import { setCourseStatusAction } from "@/app/actions/trainer";
import { CourseTabs } from "@/components/trainer/CourseTabs";
...
export default async function CourseAdminLayout({ children, params }: { children: React.ReactNode; params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6">
      <Link href="/trainer/courses" className="text-sm text-slate-500 hover:text-brand-600">← Mes formations</Link>
