...
import { gradeSubmissionAction } from "@/app/actions/trainer";
  ...
  return (
    <Container className="max-w-6xl">
      <div className="no-print mb-2 flex items-center justify-between">
        <Link href="/trainer/grading" className="text-sm text-slate-500 hover:text-brand-600">← Corrections</Link>
      ...
      <div className="mb-6">
        ...
        <div className="mt-1 flex flex-wrap items-center gap-2 text-sm text-slate-600">
          <span>
            Apprenant : <Link href={`/trainer/courses/${courseId}/learners/${sub.user.id}`} className="font-medium hover:underline">{sub.user.name}</Link> ({sub.user.email})
          </span>
