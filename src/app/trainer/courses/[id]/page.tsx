            ...
            <ol className="divide-y divide-slate-100">
              {m.lessons.map((l, li) => (
                <li key={l.id} className="flex flex-wrap items-center gap-3 px-4 py-2.5 hover:bg-slate-50">
                  ...
                  <Link href={`/trainer/courses/${id}/lessons/${l.id}`} className="min-w-0 flex-1 truncate font-medium hover:text-brand-700">
                    {l.title}
                  </Link>
                  ...
                  <div className="flex items-center gap-0.5">
                    ...
                    <Link href={`/trainer/courses/${id}/lessons/${l.id}`} className="btn-ghost btn-sm">Éditer</Link>
                  </div>
                </li>
              ))}
            </ol>
